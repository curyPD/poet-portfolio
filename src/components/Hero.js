                ...
                <div className="lg:-mt-10 lg:w-3/5">
                    ...
                    <div className="flex items-center justify-center gap-2 sm:gap-8 lg:justify-start xl:gap-10">
                        <button
                            ...
                            className="border-2 border-orange-400 bg-orange-400 py-2 px-2 text-xs font-medium text-white transition-all hover:border-gray-700 hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-orange-200 sm:px-3 sm:text-base xl:px-4 xl:text-lg"
                        >
                            Все произведения
                        </button>
                        ...
                        <a
                            ...
                            className="hidden border-2 border-orange-400 bg-white py-2 px-2 text-xs font-medium text-orange-400 transition-all hover:bg-orange-400 hover:text-white focus:outline-none focus:ring-4 focus:ring-orange-200 sm:px-3 sm:text-base xl:px-4 xl:text-lg"
                        >
                            Написать сообщение
                        </a>
                    </div>
