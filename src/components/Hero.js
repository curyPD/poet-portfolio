        ...
        <section className="py-10 sm:py-16 md:py-20 xl:py-24">
            <div className="container mx-auto flex flex-col items-center gap-8 px-6 sm:gap-14 md:px-12 lg:flex-row-reverse lg:px-6 xl:max-w-screen-xl xl:gap-24 xl:px-12">
                ...
                <div className="lg:w-3/5">
                    ...
                    <p className="xl-mb-16 mb-8 text-center text-sm text-gray-500 sm:mb-10 sm:text-base md:text-lg lg:mb-12 lg:w-11/12 lg:text-left xl:text-xl xl:leading-normal">
                    ...
                    <div className="flex flex-col items-center justify-center gap-2 sm:flex-row sm:gap-8 lg:justify-start xl:gap-10">
                        <button className="group relative block py-2 px-1 text-base font-medium md:text-lg lg:px-3 xl:px-5 xl:py-3 xl:text-xl">
                            ...
                            <span className="absolute bottom-1 left-1/2 z-0 h-0.5 w-full -translate-x-1/2 bg-amber-500 transition-all group-hover:bottom-0 group-hover:h-full group-hover:w-full lg:w-11/12 xl:bottom-2"></span>
                        </button>

                        <a
                            href="mailto: stas1365iv@gmail.com"
                            className="group relative block py-2 px-1 text-base font-medium md:text-lg lg:px-3 xl:py-3 xl:px-5 xl:text-xl"
                        >
                            <span className="relative z-10 text-gray-700 transition-colors group-hover:text-white">
                                Написать сообщение
                            </span>
